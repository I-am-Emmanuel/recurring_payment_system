...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\user\Documents\dukka_task\physical_power_test\dukka_project'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\user\Documents\dukka_task\physical_power_test\dukka_project\Scripts\deactivate.nu'
